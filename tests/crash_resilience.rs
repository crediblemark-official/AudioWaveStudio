...
fn all_styles() -> Vec<VisualizerStyle> {
    vec![
        ...
        VisualizerStyle::CyberHorizon,
        VisualizerStyle::CyberBlackHole,
        VisualizerStyle::SupernovaBurst,
        VisualizerStyle::QuantumEye,
        VisualizerStyle::ChronoReactor,
        VisualizerStyle::SolarFlareCrown,
        VisualizerStyle::WarpDrive,
        VisualizerStyle::NeonBiohazard,
        VisualizerStyle::NeonLotus,
        VisualizerStyle::HolographicVinyl,
        VisualizerStyle::AcousticCymascope,
        VisualizerStyle::SynthwaveHighway3D,
        VisualizerStyle::MercuryFluid,
        VisualizerStyle::NeonMetropolis3D,
        VisualizerStyle::MatrixRain,
        VisualizerStyle::QuantumRibbon,
        VisualizerStyle::AudioPrism3D,
        VisualizerStyle::VaporwaveDeck3D,
        VisualizerStyle::NebulaCloud3D,
        VisualizerStyle::CyberTunnel3D,
        VisualizerStyle::LaserWall,
        ...
        VisualizerStyle::RadialRipple3D,
        VisualizerStyle::Waterfall3D,
        VisualizerStyle::CassetteTape,
        VisualizerStyle::VinylRecord,
        VisualizerStyle::Turntable,
        VisualizerStyle::RetroRadio,
        VisualizerStyle::DjController,
        VisualizerStyle::SpeakerExplosion,
        VisualizerStyle::OrbitSpike,
        VisualizerStyle::CyberRing3D,
        VisualizerStyle::HologramStage,
        VisualizerStyle::DualPortalBridge,
        VisualizerStyle::ParticleWave3D,
    ]
}
